 ...
 */
	...
	Router::connect('/catalog', array('controller' => 'products', 'action' => 'products'));
    Router::connect('/catalog/:limit', array('controller' => 'products', 'action' => 'products'), array('pass' => array('limit')));
