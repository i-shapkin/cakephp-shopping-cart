...
<input type="image" name="Google Checkout" alt="Fast checkout through Google" src="http://checkout.google.com/buttons/checkout.gif?merchant_id=<?php echo Configure::read('Settings.GOOGLE_CHECKOUT_MERCHANT_ID'); ?>&w=160&h=43&style=white&variant=text&loc=ru_RU" height="43" width="160"/>
</form>
